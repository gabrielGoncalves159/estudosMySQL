...
CREATE TABLE Candidatos (
    ...
    CONSTRAINT FK_Candidatos_PatidoPolitico FOREIGN KEY (PartidoPolitico) REFERENCES PartidosPolitico(Id),
    CONSTRAINT FK_Candidatos_CargoDisputado FOREIGN KEY (CargoDisputado) REFERENCES CargosDisputados(Id)
);

CREATE TABLE Votos (
	NumeroDeCandidatos CHAR(15) NOT NULL
);
